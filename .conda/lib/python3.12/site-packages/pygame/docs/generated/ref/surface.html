...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.Surface &#8212; pygame-ce v2.5.3 documentation</title>
...
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="surface.html#pygame.Surface.premul_alpha_ip">pygame.Surface.premul_alpha_ip</a></div>
</td>
<td>—</td>
<td>multiplies the RGB channels by the surface alpha channel.</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="surface.html#pygame.Surface.width">pygame.Surface.width</a></div>
</td>
<td>—</td>
<td>Surface width in pixels (read-only)</td>
</tr>
<tr class="row-odd"><td><div class="line"><a class="toc reference external" href="surface.html#pygame.Surface.height">pygame.Surface.height</a></div>
</td>
<td>—</td>
<td>Surface height in pixels (read-only)</td>
</tr>
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="surface.html#pygame.Surface.size">pygame.Surface.size</a></div>
</td>
<td>—</td>
...
<div class="line"><span class="signature">get_colorkey() -&gt; RGBA or None</span></div>
</div>
...
<div class="line"><span class="signature">get_palette() -&gt; [Color, Color, Color, ...]</span></div>
</div>
...
<div class="line"><span class="signature">set_palette([color, color, color, ...], /) -&gt; None</span></div>
</div>
...
<p>Multiplies the RGB channels of the surface by the alpha channel in place and returns the surface.</p>
<p>Surfaces without an alpha channel cannot use this method and will return an error if you use
it on them. It is best used on 32 bit surfaces (the default on most platforms) as the blitting
on these surfaces can be accelerated by SIMD versions of the pre-multiplied blitter.</p>
